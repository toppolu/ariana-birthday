...
function renderDoors() {
  ...
  for (let i = 1; i <= QUEST.endDay; i++) {
    ...
    ribbon.textContent = i === 17 ? "🎉" : ribbonEmojis[i - 1];
    ...
    if (i === 17) btn.classList.add("door--finale");
    ...
    if (!unlocked) {
      ...
      if (opened) btn.classList.add("door--opened");
      if (today === i) btn.classList.add("door--today");
...
function memoryGame() {
  ...
  function mount(root) {
    ...
    root.innerHTML = `
      ...
      <div class="sep"></div>
      <div class="small" id="msg"></div>
      <button class="btn btn--secondary" id="showBtn" style="width:100%; margin-top:10px">Peek (1s)</button>
    `;
    renderPad();
  ...
  function tap(s) {
    ...
    if (s !== seq[idx]) {
      setMsg("Oops — try again. Tap “Peek (1s)” 💛");
      input = [];
      return;
    }
...
// ---- Letter Game ----
function letterGame({ title, lines }) {
  let opened = false;
    ...
    root.innerHTML = `
      ...
      <div id="letter" class="hidden letter-card">
        ...
        <div id="letterImg" style="opacity:0; transform:translateY(8px); transition:opacity .5s ease, transform .5s ease;">
          <img src="./ariana-ilu.png" alt="Ariana" class="letter-photo" />
        </div>
        <div class="sep"></div>
...
function birthdayFinaleGame() {
  const PAGES = [
    ...
    },
    {
      ...
      text:"You're not just 7 — you're 7 levels of awesomeness! 🌟<br>Warning: this girl causes excessive sparkle wherever she goes. ✨",
    },
    {
      anim:"heart",
      decos:[{e:"💜",l:"-24px",t:"44px"},{e:"💖",l:"114%",t:"28px"},{e:"💜",l:"44%",t:"-24px"}],
...
`<svg viewBox="0 0 160 160" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="bg0" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#0d0827"/><stop offset="65%" stop-color="#1a155a"/><stop offset="100%" stop-color="#0d2030"/></linearGradient><radialGradient id="mn0" cx="50%" cy="50%" r="50%"><stop offset="0%" stop-color="#fff9d0"/><stop offset="100%" stop-color="#ffe566"/></radialGradient></defs><rect width="160" height="160" fill="url(#bg0)"/><circle cx="22" cy="13" r="1.3" fill="#fff"><animate attributeName="opacity" values="1;.1;1" dur="2.4s" repeatCount="indefinite"/></circle><circle cx="50" cy="8" r="1.6" fill="#ffe97a"><animate attributeName="opacity" values="1;.1;1" dur="1.7s" begin=".5s" repeatCount="indefinite"/></circle><circle cx="76" cy="19" r="1.1" fill="#fff"><animate attributeName="opacity" values="1;.15;1" dur="2.7s" begin="1.1s" repeatCount="indefinite"/></circle><circle cx="98" cy="9" r="1.4" fill="#fff"><animate attributeName="opacity" values="1;.1;1" dur="2.0s" begin=".3s" repeatCount="indefinite"/></circle><circle cx="125" cy="5" r="1.2" fill="#ffe97a"><animate attributeName="opacity" values="1;.2;1" dur="1.9s" begin=".8s" repeatCount="indefinite"/></circle><circle cx="148" cy="20" r="1.1" fill="#fff"><animate attributeName="opacity" values="1;.1;1" dur="2.5s" begin="1.4s" repeatCount="indefinite"/></circle><circle cx="36" cy="34" r=".9" fill="#fff"><animate attributeName="opacity" values="1;.2;1" dur="3.0s" begin=".2s" repeatCount="indefinite"/></circle><circle cx="88" cy="30" r="1.3" fill="#fff"><animate attributeName="opacity" values="1;.1;1" dur="1.8s" begin="1.6s" repeatCount="indefinite"/></circle><circle cx="112" cy="42" r=".8" fill="#fff"><animate attributeName="opacity" values="1;.15;1" dur="2.9s" begin=".4s" repeatCount="indefinite"/></circle><circle cx="138" cy="27" r="1.1" fill="#ffe97a"><animate attributeName="opacity" values="1;.1;1" dur="2.1s" begin="1.2s" repeatCount="indefinite"/></circle><circle cx="8" cy="55" r=".8" fill="#fff"><animate attributeName="opacity" values="1;.2;1" dur="3.2s" begin="1.8s" repeatCount="indefinite"/></circle><circle cx="155" cy="54" r=".9" fill="#fff"><animate attributeName="opacity" values="1;.1;1" dur="2.3s" begin=".6s" repeatCount="indefinite"/></circle><circle cx="30" cy="34" r="22" fill="#ffe97a" opacity=".13"/><circle cx="30" cy="34" r="14" fill="url(#mn0)"/><circle cx="38" cy="28" r="12" fill="#1a155a"/><ellipse cx="-8" cy="148" rx="75" ry="44" fill="#081a0c"/><ellipse cx="168" cy="150" rx="72" ry="40" fill="#081a0c"/><path d="M0,136 Q40,108 80,122 Q120,108 160,128 L160,160 L0,160Z" fill="#0d2418"/><g fill="#05100a"><path d="M74,124 Q70,134 68,142 Q76,139 80,140 Q84,139 92,142 Q90,134 86,124Z"/><rect x="76" y="112" width="8" height="13" rx="2"/><path d="M75,103 Q68,106 67,114" stroke="#05100a" stroke-width="3.5" fill="none"/><path d="M85,103 Q92,106 93,114" stroke="#05100a" stroke-width="3.5" fill="none"/><path d="M76,116 Q58,96 44,72" stroke="#05100a" stroke-width="2.5" fill="none" stroke-linecap="round"/></g><circle cx="42" cy="70" r="2.5" fill="#ffe97a"><animate attributeName="opacity" values="1;.2;1" dur="1.2s" repeatCount="indefinite"/><animate attributeName="r" values="2.5;3.5;2.5" dur="1.2s" repeatCount="indefinite"/></circle><g><animateTransform attributeName="transform" type="translate" values="0,0;0,0;-68,45;-68,45" keyTimes="0;0.54;0.82;1" dur="5s" repeatCount="indefinite"/><line x1="148" y1="13" x2="158" y2="7" stroke="white" stroke-width="2" stroke-linecap="round"><animate attributeName="opacity" values="0;0;.9;.6;0;0" keyTimes="0;0.53;0.57;0.82;0.86;1" dur="5s" repeatCount="indefinite"/></line></g></svg>`,
...
`<svg viewBox="0 0 160 160" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="bg2" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#0e041e"/><stop offset="55%" stop-color="#1e0a3c"/><stop offset="100%" stop-color="#2d1a52"/></linearGradient><radialGradient id="cga2" cx="50%" cy="50%" r="50%"><stop offset="0%" stop-color="#00ffd4" stop-opacity=".65"/><stop offset="100%" stop-color="#00ffd4" stop-opacity="0"/></radialGradient><radialGradient id="cgb2" cx="50%" cy="50%" r="50%"><stop offset="0%" stop-color="#ff70d4" stop-opacity=".6"/><stop offset="100%" stop-color="#ff70d4" stop-opacity="0"/></radialGradient></defs><rect width="160" height="160" fill="url(#bg2)"/><circle cx="20" cy="12" r="1" fill="#fff" opacity=".7"/><circle cx="55" cy="7" r="1.3" fill="#ffe97a" opacity=".8"/><circle cx="92" cy="15" r=".9" fill="#fff" opacity=".6"/><circle cx="130" cy="8" r="1.2" fill="#fff" opacity=".7"/><circle cx="150" cy="22" r=".8" fill="#ffe97a" opacity=".6"/><path d="M0,100 L25,74 L40,87 L60,70 L80,82 L100,64 L120,80 L140,68 L160,84 L160,160 L0,160Z" fill="#1a0f2e"/><path d="M0,115 L30,94 L50,105 L70,90 L90,100 L110,84 L130,96 L155,88 L160,94 L160,160 L0,160Z" fill="#241540"/><path d="M0,130 Q40,118 80,124 Q120,118 160,130 L160,160 L0,160Z" fill="#1a0f2e"/><ellipse cx="38" cy="88" rx="16" ry="22" fill="url(#cga2)"><animate attributeName="opacity" values=".7;1;.7" dur="2.2s" repeatCount="indefinite"/></ellipse><ellipse cx="115" cy="76" rx="13" ry="19" fill="url(#cgb2)"><animate attributeName="opacity" values=".6;1;.6" dur="2.8s" begin=".5s" repeatCount="indefinite"/></ellipse><ellipse cx="72" cy="98" rx="9" ry="13" fill="url(#cga2)"><animate attributeName="opacity" values=".7;1;.7" dur="1.9s" begin="1s" repeatCount="indefinite"/></ellipse><polygon points="38,114 30,76 38,68 46,76" fill="#00ffd4"><animate attributeName="opacity" values=".65;.95;.65" dur="2.2s" repeatCount="indefinite"/></polygon><polygon points="38,114 38,68 48,82" fill="#00d4b0"><animate attributeName="opacity" values=".5;.8;.5" dur="2.2s" begin=".2s" repeatCount="indefinite"/></polygon><polygon points="115,106 107,72 115,65 123,72" fill="#ff70d4"><animate attributeName="opacity" values=".65;.95;.65" dur="2.8s" begin=".5s" repeatCount="indefinite"/></polygon><polygon points="115,106 115,65 125,78" fill="#cc50aa"><animate attributeName="opacity" values=".5;.8;.5" dur="2.8s" begin=".7s" repeatCount="indefinite"/></polygon><polygon points="72,120 67,98 72,93 77,98" fill="#00ffd4"><animate attributeName="opacity" values=".55;.9;.55" dur="1.9s" begin="1s" repeatCount="indefinite"/></polygon><line x1="82" y1="0" x2="38" y2="80" stroke="#ffe97a" stroke-width="2"><animate attributeName="opacity" values=".15;.45;.15" dur="2.8s" begin=".3s" repeatCount="indefinite"/></line><line x1="90" y1="0" x2="115" y2="72" stroke="#ffe97a" stroke-width="1.5"><animate attributeName="opacity" values=".1;.38;.1" dur="2.8s" begin=".8s" repeatCount="indefinite"/></line><g><circle cx="78" cy="83" r="4.5" fill="#b090e8" opacity="0.9"/><path d="M78,87 L70,108 L86,108Z" fill="#8060c0" opacity="0.85"/><path d="M76,87 Q66,74 56,62" stroke="#8060c0" stroke-width="2.5" fill="none" stroke-linecap="round"/><path d="M80,87 Q87,82 92,86" stroke="#8060c0" stroke-width="2" fill="none" stroke-linecap="round"/></g><circle cx="38" cy="66" r="2.5" fill="#00ffd4"><animate attributeName="opacity" values=".7;1;.7" dur="1.5s" repeatCount="indefinite"/><animate attributeName="r" values="2.5;3.5;2.5" dur="1.5s" repeatCount="indefinite"/></circle><circle cx="115" cy="63" r="2" fill="#ff70d4"><animate attributeName="opacity" values=".7;1;.7" dur="1.8s" begin=".4s" repeatCount="indefinite"/><animate attributeName="r" values="2;3;2" dur="1.8s" begin=".4s" repeatCount="indefinite"/></circle><circle cx="72" cy="91" r="1.5" fill="#00ffd4"><animate attributeName="opacity" values=".6;1;.6" dur="2.1s" begin=".8s" repeatCount="indefinite"/></circle></svg>`,
// ── Scene 3: Inner Light ("She found the secret.") ──────
`<svg viewBox="0 0 160 160" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="bg3" cx="50%" cy="55%" r="65%"><stop offset="0%" stop-color="#fff8dc"/><stop offset="50%" stop-color="#ffe4a0"/><stop offset="100%" stop-color="#ffb347"/></radialGradient><radialGradient id="gl3" cx="50%" cy="50%" r="50%"><stop offset="0%" stop-color="#fff" stop-opacity=".8"/><stop offset="100%" stop-color="#ffd700" stop-opacity="0"/></radialGradient></defs><rect width="160" height="160" fill="url(#bg3)"/><line x1="80" y1="95" x2="80" y2="5" stroke="#ffd700" stroke-width="3"><animate attributeName="opacity" values=".35;.65;.35" dur="2.5s" repeatCount="indefinite"/></line><line x1="80" y1="95" x2="152" y2="38" stroke="#ffd700" stroke-width="2.5"><animate attributeName="opacity" values=".35;.65;.35" dur="2.5s" begin=".2s" repeatCount="indefinite"/></line><line x1="80" y1="95" x2="160" y2="95" stroke="#ffd700" stroke-width="2"><animate attributeName="opacity" values=".35;.65;.35" dur="2.5s" begin=".4s" repeatCount="indefinite"/></line><line x1="80" y1="95" x2="152" y2="152" stroke="#ffd700" stroke-width="2"><animate attributeName="opacity" values=".35;.65;.35" dur="2.5s" begin=".6s" repeatCount="indefinite"/></line><line x1="80" y1="95" x2="80" y2="160" stroke="#ffd700" stroke-width="2.5"><animate attributeName="opacity" values=".35;.65;.35" dur="2.5s" begin=".8s" repeatCount="indefinite"/></line><line x1="80" y1="95" x2="8" y2="152" stroke="#ffd700" stroke-width="2"><animate attributeName="opacity" values=".35;.65;.35" dur="2.5s" begin="1.0s" repeatCount="indefinite"/></line><line x1="80" y1="95" x2="0" y2="95" stroke="#ffd700" stroke-width="2"><animate attributeName="opacity" values=".35;.65;.35" dur="2.5s" begin="1.2s" repeatCount="indefinite"/></line><line x1="80" y1="95" x2="8" y2="38" stroke="#ffd700" stroke-width="2.5"><animate attributeName="opacity" values=".35;.65;.35" dur="2.5s" begin="1.4s" repeatCount="indefinite"/></line><line x1="80" y1="95" x2="130" y2="18" stroke="#ffd700" stroke-width="1.5"><animate attributeName="opacity" values=".25;.5;.25" dur="2.5s" begin=".1s" repeatCount="indefinite"/></line><line x1="80" y1="95" x2="30" y2="18" stroke="#ffd700" stroke-width="1.5"><animate attributeName="opacity" values=".25;.5;.25" dur="2.5s" begin=".3s" repeatCount="indefinite"/></line><circle cx="80" cy="95" r="38" fill="url(#gl3)"/><g fill="#7a4000" opacity=".8"><path d="M68,88 Q48,76 30,70" stroke="#7a4000" stroke-width="5" fill="none" stroke-linecap="round"/><path d="M92,88 Q112,76 130,70" stroke="#7a4000" stroke-width="5" fill="none" stroke-linecap="round"/><path d="M72,88 Q70,105 68,120 Q76,117 80,118 Q84,117 92,120 Q90,105 88,88Z"/><rect x="72" y="78" width="16" height="12" rx="2"/><path d="M72,64 Q64,70 63,80" stroke="#7a4000" stroke-width="4" fill="none"/><path d="M88,64 Q96,70 97,80" stroke="#7a4000" stroke-width="4" fill="none"/></g><path d="M80,91 L74,84 Q71,79 75,77 Q79,75 80,79 Q81,75 85,77 Q89,79 86,84Z" fill="#ffd700"><animate attributeName="opacity" values=".8;1;.8" dur="1.2s" repeatCount="indefinite"/></path><circle cx="55" cy="42" r="3" fill="#ffd700"><animate attributeName="cy" values="42;18;42" dur="3s" repeatCount="indefinite"/><animate attributeName="opacity" values=".85;0;.85" dur="3s" repeatCount="indefinite"/></circle><circle cx="105" cy="36" r="2.5" fill="#ffd700"><animate attributeName="cy" values="36;10;36" dur="2.5s" begin=".5s" repeatCount="indefinite"/><animate attributeName="opacity" values=".75;0;.75" dur="2.5s" begin=".5s" repeatCount="indefinite"/></circle><circle cx="38" cy="58" r="2" fill="#ffd700"><animate attributeName="cy" values="58;32;58" dur="3.5s" begin="1s" repeatCount="indefinite"/><animate attributeName="opacity" values=".65;0;.65" dur="3.5s" begin="1s" repeatCount="indefinite"/></circle><circle cx="122" cy="62" r="2" fill="#ffd700"><animate attributeName="cy" values="62;36;62" dur="2.8s" begin="1.5s" repeatCount="indefinite"/><animate attributeName="opacity" values=".7;0;.7" dur="2.8s" begin="1.5s" repeatCount="indefinite"/></circle><circle cx="80" cy="22" r="3" fill="#fff"><animate attributeName="r" values="3;5;3" dur="2s" repeatCount="indefinite"/><animate attributeName="opacity" values=".75;.25;.75" dur="2s" repeatCount="indefinite"/></circle></svg>`,
...
`<svg viewBox="0 0 160 160" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="bg5" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#ffd36e"/><stop offset="30%" stop-color="#ff9a5e"/><stop offset="62%" stop-color="#ff6b9d"/><stop offset="100%" stop-color="#8b5cf6"/></linearGradient><radialGradient id="sg5" cx="50%" cy="50%" r="50%"><stop offset="0%" stop-color="#fff" stop-opacity=".85"/><stop offset="100%" stop-color="#ffd36e" stop-opacity="0"/></radialGradient></defs><rect width="160" height="160" fill="url(#bg5)"/><circle cx="80" cy="92" r="32" fill="url(#sg5)"/><circle cx="80" cy="92" r="16" fill="#fff" opacity=".82"/><ellipse cx="28" cy="56" rx="20" ry="7" fill="#ff9a5e" opacity=".5"/><ellipse cx="15" cy="52" rx="11" ry="6" fill="#ff9a5e" opacity=".4"/><ellipse cx="132" cy="46" rx="17" ry="6" fill="#ffb36e" opacity=".4"/><ellipse cx="148" cy="42" rx="10" ry="5" fill="#ffb36e" opacity=".35"/><circle cx="22" cy="18" r="1.4" fill="#fff"><animate attributeName="opacity" values=".1;.85;.1" dur="3s" repeatCount="indefinite"/></circle><circle cx="55" cy="12" r="1.0" fill="#fff"><animate attributeName="opacity" values=".1;.85;.1" dur="2.5s" begin=".8s" repeatCount="indefinite"/></circle><circle cx="105" cy="14" r="1.2" fill="#fff"><animate attributeName="opacity" values=".1;.85;.1" dur="3.2s" begin="1.5s" repeatCount="indefinite"/></circle><circle cx="138" cy="20" r="1.0" fill="#fff"><animate attributeName="opacity" values=".1;.85;.1" dur="2.8s" begin=".4s" repeatCount="indefinite"/></circle><ellipse cx="80" cy="160" rx="100" ry="42" fill="#1a0f2e"/><path d="M0,145 Q40,128 80,134 Q120,128 160,142 L160,160 L0,160Z" fill="#0d0820"/><g fill="#0a0520"><path d="M64,132 Q62,148 60,158 L68,158 Q69,148 70,140Z"/><path d="M76,132 Q77,148 77,158 L69,158 Q68,148 70,140Z"/><rect x="62" y="116" width="16" height="17" rx="2"/><circle cx="70" cy="108" r="8.5"/><path d="M62,104 Q55,108 55,117" stroke="#0a0520" stroke-width="3.5" fill="none"/></g><g fill="#0a0520"><path d="M88,140 Q86,152 84,158 L92,158 Q93,152 92,146Z"/><path d="M98,140 Q98,152 96,158 L88,158 Q87,152 90,146Z"/><rect x="86" y="128" width="12" height="13" rx="2"/><path d="M86,116 Q80,118 78,125" stroke="#0a0520" stroke-width="3" fill="none"/><path d="M98,116 Q104,118 106,125" stroke="#0a0520" stroke-width="3" fill="none"/></g><path d="M76,128 Q84,132 86,132" stroke="#0a0520" stroke-width="4.5" fill="none" stroke-linecap="round"/><text x="72" y="102" font-size="14" text-anchor="middle">💜<animate attributeName="y" values="102;12;102" dur="2.5s" repeatCount="indefinite"/><animate attributeName="opacity" values=".9;0;.9" dur="2.5s" repeatCount="indefinite"/></text><text x="90" y="96" font-size="11" text-anchor="middle">💖<animate attributeName="y" values="96;6;96" dur="3s" begin=".7s" repeatCount="indefinite"/><animate attributeName="opacity" values=".9;0;.9" dur="3s" begin=".7s" repeatCount="indefinite"/></text><text x="58" y="100" font-size="12" text-anchor="middle">💜<animate attributeName="y" values="100;10;100" dur="2.8s" begin="1.4s" repeatCount="indefinite"/><animate attributeName="opacity" values=".9;0;.9" dur="2.8s" begin="1.4s" repeatCount="indefinite"/></text><text x="103" y="106" font-size="10" text-anchor="middle">💕<animate attributeName="y" values="106;16;106" dur="3.5s" begin=".3s" repeatCount="indefinite"/><animate attributeName="opacity" values=".9;0;.9" dur="3.5s" begin=".3s" repeatCount="indefinite"/></text></svg>`,
    ];
